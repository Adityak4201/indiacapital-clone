...
/***/ (function(module, exports, __webpack_require__) {
    ...
    var nullthrows = __webpack_require__(46);
    ...
    var console = __webpack_require__(40);
    ...
    "use strict";
    /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "v", function() { return __DEBUG__; });
    /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "o", function() { return TREE_OPERATION_ADD; });
    /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "p", function() { return TREE_OPERATION_REMOVE; });
    /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "r", function() { return TREE_OPERATION_REORDER_CHILDREN; });
    /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "t", function() { return TREE_OPERATION_UPDATE_TREE_BASE_DURATION; });
    /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "s", function() { return TREE_OPERATION_UPDATE_ERRORS_OR_WARNINGS; });
    /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "q", function() { return TREE_OPERATION_REMOVE_ROOT; });
    ...
    /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "u", function() { return UNSUPPORTED_VERSION_URL; });
    /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "k", function() { return REACT_DEVTOOLS_WORKPLACE_URL; });
    /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "n", function() { return THEME_STYLES; });
    ...
    function printOperationsArray(operations) {
      ...
      while (i < operations.length) {
        ...
        switch (operation) {
          case constants["o" /* TREE_OPERATION_ADD */]:
            {
          ...
          case constants["p" /* TREE_OPERATION_REMOVE */]:
            {
          ...
          case constants["q" /* TREE_OPERATION_REMOVE_ROOT */]:
            {
              i += 1;
          ...
          case constants["r" /* TREE_OPERATION_REORDER_CHILDREN */]:
            {
              const id = operations[i + 1];
          ...
          case constants["t" /* TREE_OPERATION_UPDATE_TREE_BASE_DURATION */]:
          ...
          case constants["s" /* TREE_OPERATION_UPDATE_ERRORS_OR_WARNINGS */]:
            const id = operations[i + 1];
    ...
    const Yallist = __webpack_require__(52);
    ...
    */
    ...
    var backend_renderer = __webpack_require__(42);
    ...
    var react_debug_tools = __webpack_require__(56);
    
    // EXTERNAL MODULE: ../react-devtools-shared/src/backend/console.js + 3 modules
    var backend_console = __webpack_require__(40);
    ...
    function attach(hook, rendererID, renderer, global) {
      ...
      function updateComponentFilters(componentFilters) {
        ...
        hook.getFiberRoots(rendererID).forEach(root => {
          ...
          pushOperation(constants["q" /* TREE_OPERATION_REMOVE_ROOT */]);
      ...
      function recordPendingErrorsAndWarnings() {
        ...
        fibersWithChangedErrorOrWarningCounts.forEach(fiber => {
          ...
          if (fiberID === null) {// Don't send updates for Fibers that didn't mount due to e.g. Suspense or an error boundary.
            ...
            pushOperation(constants["s" /* TREE_OPERATION_UPDATE_ERRORS_OR_WARNINGS */]);
      ...
      function flushPendingEvents(root) {
        ...
        if (numUnmountIDs > 0) {
          ...
          operations[i++] = constants["p" /* TREE_OPERATION_REMOVE */]; // The first number is how many unmounted IDs we're gonna send.
      ...
      function recordMount(fiber, parentFiber) {
        ...
        if (isRoot) {
          pushOperation(constants["o" /* TREE_OPERATION_ADD */]);
          pushOperation(id);
      ...
      function recordProfilingDurations(fiber) {
        ...
        if (isProfiling) {
          ...
          if (alternate == null || treeBaseDuration !== alternate.treeBaseDuration) {
            ...
            pushOperation(constants["t" /* TREE_OPERATION_UPDATE_TREE_BASE_DURATION */]);
            pushOperation(id);
      ...
      function recordResetChildren(fiber, childSet) {
        ...
        pushOperation(constants["r" /* TREE_OPERATION_REORDER_CHILDREN */]);
    ...
    try {
      ...
      __webpack_require__(53)(Yallist);
    } catch (er) {}
